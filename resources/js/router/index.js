...
const routes = [
    ...
    // Admin
    {
        ...
        children: [
            ...
            { path: 'certificates/cc', name: 'admin.certificates.cc', component: () => import('@/pages/admin/certificates/CcEmailListPage.vue') },
    ...
    // Organization portal — reuses the admin screens, scoped to the org.
    {
        ...
        children: [
            ...
            { path: 'certificates/cc', name: 'org.certificates.cc', component: () => import('@/pages/admin/certificates/CcEmailListPage.vue') },
