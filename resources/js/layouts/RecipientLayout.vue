        ...
        <header class="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
            <div class="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6">
                ...
                <nav class="flex items-center gap-1 text-sm font-medium sm:gap-3">
                    ...
                    <button class="rounded-lg bg-slate-100 dark:bg-slate-800 px-3 py-2 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700" @click="logout">
                        Sign out
                    </button>
                </nav>
            </div>
